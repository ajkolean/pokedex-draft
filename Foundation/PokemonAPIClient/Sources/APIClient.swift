...
struct APIClient {
    ...
    public var fetchEncounterConditionValue: @Sendable (_ name: EncounterConditionValueName) async throws -> EncounterConditionValue
    public var fetchEncounterConditionValueList: @Sendable (_ limit: Int, _ offset: Int) async throws -> [EncounterConditionValueName]
...
extension APIClient {
    static let liveValue = Self(
        ...
        fetchBerryList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .berry, limit: limit, offset: offset)
            return response.results.map { BerryName(rawValue: $0.name) }
        },
        fetchBerryFirmness: { name in
            let response = try await NetworkManager.shared.fetch(BerryFirmnessResponse.self, endpoint: .berryFirmness, identifier: name)
            return BerryFirmness(apiModel: response)
        },
        fetchBerryFirmnessList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .berryFirmness, limit: limit, offset: offset)
            return response.results.map { BerryFirmnessName(rawValue: $0.name) }
        },
        fetchBerryFlavor: { name in
            let response = try await NetworkManager.shared.fetch(BerryFlavorResponse.self, endpoint: .berryFlavor, identifier: name)
            return BerryFlavor(apiModel: response)
        },
        fetchBerryFlavorList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .berryFlavor, limit: limit, offset: offset)
            return response.results.map { BerryFlavorName(rawValue: $0.name) }
        },
        fetchContestType: { name in
            let response = try await NetworkManager.shared.fetch(ContestTypeResponse.self, endpoint: .contestType, identifier: name)
            return ContestType(apiModel: response)
        },
        fetchContestTypeList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .contestType, limit: limit, offset: offset)
            return response.results.map { ContestTypeName(rawValue: $0.name) }
        },
        fetchContestEffect: { id in
            let response = try await NetworkManager.shared.fetch(ContestEffectResponse.self, endpoint: .contestEffect, identifier: id)
            return ContestEffect(apiModel: response)
        },
        fetchContestEffectList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(APIResourceListResponse.self, endpoint: .contestEffect, limit: limit, offset: offset)
            return response.results.map { ContestEffectID(rawValue: $0.url.extractID()) }
        },
        fetchSuperContestEffect: { id in
            let response = try await NetworkManager.shared.fetch(SuperContestEffectResponse.self, endpoint: .superContestEffect, identifier: id)
            return SuperContestEffect(apiModel: response)
        },
        fetchSuperContestEffectList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(APIResourceListResponse.self, endpoint: .superContestEffect, limit: limit, offset: offset)
            return response.results.map { ContestEffectID(rawValue: $0.url.extractID()) }
        },
        fetchEncounterMethod: { name in
            let response = try await NetworkManager.shared.fetch(EncounterMethodResponse.self, endpoint: .encounterMethod, identifier: name)
            return EncounterMethod(apiModel: response)
        },
        fetchEncounterMethodList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .encounterMethod, limit: limit, offset: offset)
            return response.results.map { EncounterMethodName(rawValue: $0.name) }
        },
        fetchEncounterCondition: { name in
            let response = try await NetworkManager.shared.fetch(EncounterConditionResponse.self, endpoint: .encounterCondition, identifier: name)
            return EncounterCondition(apiModel: response)
        },
        fetchEncounterConditionList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .encounterCondition, limit: limit, offset: offset)
            return response.results.map { EncounterConditionName(rawValue: $0.name) }
        },
        fetchEncounterConditionValue: { name in
            let response = try await NetworkManager.shared.fetch(EncounterConditionValueResponse.self, endpoint: .encounterConditionValue, identifier: name)
            return EncounterConditionValue(apiModel: response)
        },
        fetchEncounterConditionValueList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .encounterConditionValue, limit: limit, offset: offset)
            return response.results.map { EncounterConditionValueName(rawValue: $0.name) }
        },
        fetchEvolutionChain: { id in
            let response = try await NetworkManager.shared.fetch(EvolutionChainResponse.self, endpoint: .evolutionChain, identifier: id)
            return EvolutionChain(apiModel: response)
        },
        fetchEvolutionChainList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(APIResourceListResponse.self, endpoint: .evolutionChain, limit: limit, offset: offset)
            return response.results.map { EvolutionChainID(rawValue: $0.url.extractID()) }
        },
        fetchEvolutionTrigger: { name in
            let response = try await NetworkManager.shared.fetch(EvolutionTriggerResponse.self, endpoint: .evolutionTrigger, identifier: name)
            return EvolutionTrigger(apiModel: response)
        },
        fetchEvolutionTriggerList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .evolutionTrigger, limit: limit, offset: offset)
        ...
        fetchGenerationList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .generation, limit: limit, offset: offset)
        ...
        fetchPokedexList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokedex, limit: limit, offset: offset)
        ...
        fetchVersionList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .version, limit: limit, offset: offset)
            return response.results.map { VersionName(rawValue: $0.name) }
        },
        fetchVersionGroup: { name in
            let response = try await NetworkManager.shared.fetch(VersionGroupResponse.self, endpoint: .versionGroup, identifier: name)
            return VersionGroup(apiModel: response)
        },
        fetchVersionGroupList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .versionGroup, limit: limit, offset: offset)
        ...
        fetchItemList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .item, limit: limit, offset: offset)
            return response.results.map { ItemName(rawValue: $0.name) }
        },
        fetchItemAttribute: { name in
            let response = try await NetworkManager.shared.fetch(ItemAttributeResponse.self, endpoint: .itemAttribute, identifier: name)
            return ItemAttribute(apiModel: response)
        },
        fetchItemAttributeList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .itemAttribute, limit: limit, offset: offset)
            return response.results.map { ItemAttributeName(rawValue: $0.name) }
        },
        fetchItemCategory: { name in
            let response = try await NetworkManager.shared.fetch(ItemCategoryResponse.self, endpoint: .itemCategory, identifier: name)
            return ItemCategory(apiModel: response)
        },
        fetchItemCategoryList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .itemCategory, limit: limit, offset: offset)
            return response.results.map { ItemCategoryName(rawValue: $0.name) }
        },
        fetchItemFlingEffect: { name in
            let response = try await NetworkManager.shared.fetch(ItemFlingEffectResponse.self, endpoint: .itemFlingEffect, identifier: name)
            return ItemFlingEffect(apiModel: response)
        },
        fetchItemFlingEffectList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .itemFlingEffect, limit: limit, offset: offset)
        ...
        fetchItemPocketList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .itemPocket, limit: limit, offset: offset)
        ...
        fetchLocationList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .location, limit: limit, offset: offset)
            return response.results.map { LocationName(rawValue: $0.name) }
        },
        fetchLocationArea: { name in
            let response = try await NetworkManager.shared.fetch(LocationAreaResponse.self, endpoint: .locationArea, identifier: name)
            return LocationArea(apiModel: response)
        },
        fetchLocationAreaList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .locationArea, limit: limit, offset: offset)
            return response.results.map { LocationAreaName(rawValue: $0.name) }
        },
        fetchPalParkArea: { name in
            let response = try await NetworkManager.shared.fetch(PalParkAreaResponse.self, endpoint: .palParkArea, identifier: name)
            return PalParkArea(apiModel: response)
        },
        fetchPalParkAreaList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .palParkArea, limit: limit, offset: offset)
        ...
        fetchRegionList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .region, limit: limit, offset: offset)
        ...
        fetchMachineList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(APIResourceListResponse.self, endpoint: .machine, limit: limit, offset: offset)
        ...
        fetchMoveList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .move, limit: limit, offset: offset)
            return response.results.map { MoveName(rawValue: $0.name) }
        },
        fetchMoveAilment: { name in
            let response = try await NetworkManager.shared.fetch(MoveAilmentResponse.self, endpoint: .moveAilment, identifier: name)
            return MoveAilment(apiModel: response)
        },
        fetchMoveAilmentList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .moveAilment, limit: limit, offset: offset)
            return response.results.map { MoveAilmentName(rawValue: $0.name) }
        },
        fetchMoveBattleStyle: { name in
            let response = try await NetworkManager.shared.fetch(MoveBattleStyleResponse.self, endpoint: .moveBattleStyle, identifier: name)
            return MoveBattleStyle(apiModel: response)
        },
        fetchMoveBattleStyleList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .moveBattleStyle, limit: limit, offset: offset)
            return response.results.map { MoveBattleStyleName(rawValue: $0.name) }
        },
        fetchMoveCategory: { name in
            let response = try await NetworkManager.shared.fetch(MoveCategoryResponse.self, endpoint: .moveCategory, identifier: name)
            return MoveCategory(apiModel: response)
        },
        fetchMoveCategoryList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .moveCategory, limit: limit, offset: offset)
            return response.results.map { MoveCategoryName(rawValue: $0.name) }
        },
        fetchMoveDamageClass: { name in
            let response = try await NetworkManager.shared.fetch(MoveDamageClassResponse.self, endpoint: .moveDamageClass, identifier: name)
            return MoveDamageClass(apiModel: response)
        },
        fetchMoveDamageClassList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .moveDamageClass, limit: limit, offset: offset)
            return response.results.map { MoveDamageClassName(rawValue: $0.name) }
        },
        fetchMoveLearnMethod: { name in
            let response = try await NetworkManager.shared.fetch(MoveLearnMethodResponse.self, endpoint: .moveLearnMethod, identifier: name)
            return MoveLearnMethod(apiModel: response)
        },
        fetchMoveLearnMethodList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .moveLearnMethod, limit: limit, offset: offset)
        ...
        fetchMoveTargetList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .moveTarget, limit: limit, offset: offset)
        ...
        fetchAbilityList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .ability, limit: limit, offset: offset)
            return response.results.map { AbilityName(rawValue: $0.name) }
        },
        fetchCharacteristic: { id in
            let response = try await NetworkManager.shared.fetch(CharacteristicResponse.self, endpoint: .characteristic, identifier: id)
            return Characteristic(apiModel: response)
        },
        fetchCharacteristicList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(APIResourceListResponse.self, endpoint: .characteristic, limit: limit, offset: offset)
        ...
        fetchEggGroupList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .eggGroup, limit: limit, offset: offset)
        ...
        fetchGenderList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .gender, limit: limit, offset: offset)
        ...
        fetchGrowthRateList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .growthRate, limit: limit, offset: offset)
        ...
        fetchNatureList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .nature, limit: limit, offset: offset)
            return response.results.map { NatureName(rawValue: $0.name) }
        },
        fetchPokeathlonStat: { name in
            let response = try await NetworkManager.shared.fetch(PokeathlonStatResponse.self, endpoint: .pokeathlonStat, identifier: name)
            return PokeathlonStat(apiModel: response)
        },
        fetchPokeathlonStatList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokeathlonStat, limit: limit, offset: offset)
        ...
        fetchPokemonList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokemon, limit: limit, offset: offset)
            return response.results.map { PokemonName(rawValue: $0.name) }
        },
        fetchPokemonColor: { name in
            let response = try await NetworkManager.shared.fetch(PokemonColorResponse.self, endpoint: .pokemonColor, identifier: name)
            return PokemonColor(apiModel: response)
        },
        fetchPokemonColorList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokemonColor, limit: limit, offset: offset)
            return response.results.map { PokemonColorName(rawValue: $0.name) }
        },
        fetchPokemonForm: { name in
            let response = try await NetworkManager.shared.fetch(PokemonFormResponse.self, endpoint: .pokemonForm, identifier: name)
            return PokemonForm(apiModel: response)
        },
        fetchPokemonFormList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokemonForm, limit: limit, offset: offset)
            return response.results.map { PokemonFormName(rawValue: $0.name) }
        },
        fetchPokemonHabitat: { name in
            let response = try await NetworkManager.shared.fetch(PokemonHabitatResponse.self, endpoint: .pokemonHabitat, identifier: name)
            return PokemonHabitat(apiModel: response)
        },
        fetchPokemonHabitatList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokemonHabitat, limit: limit, offset: offset)
            return response.results.map { PokemonHabitatName(rawValue: $0.name) }
        },
        fetchPokemonShape: { name in
            let response = try await NetworkManager.shared.fetch(PokemonShapeResponse.self, endpoint: .pokemonShape, identifier: name)
            return PokemonShape(apiModel: response)
        },
        fetchPokemonShapeList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokemonShape, limit: limit, offset: offset)
            return response.results.map { PokemonShapeName(rawValue: $0.name) }
        },
        fetchPokemonSpecies: { name in
            let response = try await NetworkManager.shared.fetch(PokemonSpeciesResponse.self, endpoint: .pokemonSpecies, identifier: name)
            return PokemonSpecies(apiModel: response)
        },
        fetchPokemonSpeciesList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .pokemonSpecies, limit: limit, offset: offset)
        ...
        fetchStatList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .stat, limit: limit, offset: offset)
        ...
        fetchTypeList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .type, limit: limit, offset: offset)
            return response.results.map { TypeName(rawValue: $0.name) }
        },
        fetchLanguageList: { limit, offset in
            let response = try await NetworkManager.shared.fetchList(NamedAPIResourceListResponse.self, endpoint: .language, limit: limit, offset: offset)
