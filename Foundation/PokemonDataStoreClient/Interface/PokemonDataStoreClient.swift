...
public struct DataStoreClient: Sendable, TestDependencyKey {
    ...
    public var fetchTCGCardsBySetID: @Sendable (_ id: TCG.SetID) async throws -> [TCG.Card]
    public var fetchTCGCard: @Sendable (_ name: TCG.CardName) async throws -> [TCG.Card]
